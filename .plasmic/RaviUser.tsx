...
import {
  PlasmicRaviUser,
  DefaultRaviUserProps
} from "./plasmic/ravi_design_system/PlasmicRaviUser";
...
// Omit to hide them:
//
// interface RaviUserProps extends Omit<DefaultRaviUserProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
// You can also stop extending from DefaultRaviUserProps altogether and have
...
function RaviUser_(props: RaviUserProps, ref: HTMLElementRefOf<"div">) {
  ...
  // fetch data.
  //
  // Props you can pass into PlasmicRaviUser are:
