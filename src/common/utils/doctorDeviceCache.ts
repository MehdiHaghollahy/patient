...
export const DOCTOR_HOME_INLINE_REDIRECT_SCRIPT = `(function(){try{var k='${DOCTOR_DEVICE_CACHE_KEY}';if(localStorage.getItem(k)!=='1')return;var p=location.pathname;if(p==='/'||p==='/apphome')location.replace('/_/');}catch(e){}})();`;
